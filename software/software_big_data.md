...
- [Flink](https://flink.apache.org/) – фреймворк потоковой и пакетной обработки данных
...
- [Trino](https://trino.io/) – распределенный SQL-движок для аналитики данных
...
- [Dask](https://docs.dask.org/en/stable/) – параллельные вычисления и масштабирование Python-нагрузок
