# Библиотеки и другие программные решения для задач компьютерного зрения
...
- [Detectron2](https://github.com/facebookresearch/detectron2) – библиотека для задач детекции и сегментации
- [MMDetection](https://github.com/open-mmlab/mmdetection) – набор инструментов для детекции и сегментации объектов
