...
- [Axolotl](https://github.com/axolotl-ai-cloud/axolotl) — обёртка для fine-tuning LLM с поддержкой множества методов
...
- [llama.cpp](https://github.com/ggml-org/llama.cpp) — инференс LLM на CPU, квантизация GGUF
...
- [LangChain](https://docs.langchain.com/) — оркестрация цепочек вызовов LLM, RAG, агенты
